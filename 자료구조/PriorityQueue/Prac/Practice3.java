package PriorityQueue.Prac;// Practice3
...
public class Practice3 {
    public static void solution1(int[] nums, int k) {
        ...
        //여기서 x와 y는 두 개의 Map.Entry<Integer, Integer> 객체를 나타냅니다. 비교는 다음과 같은 규칙에 따라 이루어집니다:
        //만약 두 Entry의 값 (getValue())이 같다면, 키 (getKey())의 오름차순으로 정렬합니다.
        //그렇지 않으면, 값의 내림차순으로 정렬합니다.
